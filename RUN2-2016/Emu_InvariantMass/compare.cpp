...
void compare()
{
  ...
  */
  ...
  const char *filepath = "/afs/cern.ch/work/a/aalfonsi/public/datamc_run2b/data/Run2016/ana_datamc_data.root";
  ...
  const char *filepath2 = "/afs/cern.ch/work/a/aalfonsi/public/datamc_run2b/data_28072016/ana_datamc_data.root";
  ...
  //histoarray[0] -> SetMarkerStyle(20);
  ...
  TLatex *texq = new TLatex(0.4,0.97,"Data comparison");
  texq -> SetTextFont(43);
  ...
  leg -> AddEntry(histoarray[0], "Data 2016 old (6.3 fb^{-1})",  "fl");
  leg -> AddEntry(histoarray[1], "Data 2016 new (12.0 fb^{-1})",  "fl");
  leg -> Draw();
